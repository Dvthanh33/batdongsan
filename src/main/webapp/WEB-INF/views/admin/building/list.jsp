...
<div class="main-content" id="main-content">
    <div class="main-content-inner">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <label class="name">Chọn nhân viên</label>
                                            <form:select class="form-control" path="staffId">
                                                <form:option value="">---Chọn chọn nhân viên---</form:option>
        ...
        <div class="row">
            <div class="col-xs-12">
                <table id="tableList" style="margin: 3em 0 0;" class="table table-striped table-bordered table-hover text-center">
                    <thead>
                    <tr>
                        <th class="center">
                            <label class="pos-rel">
