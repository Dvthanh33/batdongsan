            ...
            <div class="row">
                    ...
                    <div class="desc-lienhe">
                        ...
                        <ul class="margin-bottom-15 link" style="list-style-type: none;">
                            <li>
                                ...
                                <span class="title-li"> Tầng 31, Keangnam Hanoi Landmark, Phạm Hùng, Nam Từ Liêm, Hà Nội</span>
                            </li>
                            <li>
                                <span class="block_fonticon"><i class="fa fa-mobile icon-lienhe"></i></span>
                                <span class="title-li">
                                        Hotline: <a style="color: #434a6e;" class="fone" href="">1900 1881</a>
                            ...
                            <li>
                                ...
                                <span class="title-li">Email: <a style="color: #434a6e;"
                                                                 href="">hotro@batdongsan.com.vn</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    ...
                    <form id="contactForm" onsubmit="sendContact(event)">
                        ...
                        <input type="text" id="phone" class="form-control mt-3" placeholder="Số điện thoại" required>
                        <input type="text" id="demand" class="form-control mt-3" placeholder="Nội dung">
                        <button type="submit"
<%--                                type="button" onclick="sendContact()" --%>
...
<script>
    function sendContact(event) {
        ...
        if (!document.getElementById("contactForm").checkValidity()) {
            return; // nếu form không hợp lệ thì dừng
        }
        const data = {
