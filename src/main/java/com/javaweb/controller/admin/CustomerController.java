...
public ModelAndView getNews(@ModelAttribute("modelSearch") CustomerSearchRequest customerSearchRequest,
...
//    model.setTotalItem(customerDTOS.size());
    ...
    public ModelAndView customerAddForm(@ModelAttribute("customerEdit") CustomerDTO customerDTO, HttpServletRequest request){
