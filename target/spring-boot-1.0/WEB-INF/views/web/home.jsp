                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <div class="img-slideshow">
                                <img src="https://anviethouse.vn/wp-content/uploads/2021/09/Thiet-ke-noi-that-can-ho-duplex-1-4_1.jpg" alt="">
                            </div>
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="row">
                                ...
                                <div class="product1 vip">
                                    ...
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Chủ nhà cần bán gấp căn hộ 3PN DT 128m2 tại Chung cư Sky Park số 3 Tôn Thất Thuyết Cầu Giấy Hà Nội</a>
                                        </div>
                                    ...
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">4,8 Tỷ</span>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1 hot">
                                    ...
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Chính chủ cần cho thuê căn 2pn nội thất mới Galaxy 9 Quận 4 ở được trong tháng 3 này, nhà như hình</a>
                                        </div>
                                        <span class="product1-conntent-title">Khu căn hộ Vinhomes Central Park được quản lý và vận hành bởi chính chủ đầu tư nên chất lượng dịch vụ rất tốt, an ninh, yên tĩnh, thừa hưởng những tiện ích sống đồng bộ.</span>
                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Số 01 Phạm Hùng</span>
                                            </li>
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Chung cư</span>
                                    ...
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">17 triệu/tháng</span>
                                        <button class="product1-footer-detail"><a href="./ChiTiet.html"
                                                                                  style="color:#fff">Xem chi
                                            tiết</a></button>
                                    </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1 vip">
                                    ...
                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Chuyên cho thuê căn hộ Vinhomes Golden River Bason 3 phòng ngủ, giỏ hàng giá tốt nhất thị trường</a>
                                        </div>
                                        <span class="product1-conntent-title">Dự án Sky Park Residence số 3 Tôn Thất
                                        ...
                                        <ul class="product1-conntent-list">
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 80m2 - 189m2</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">45 triệu/tháng</span>
                                        <button class="product1-footer-detail"><a href="./ChiTiet.html"
                                                                                  style="color:#fff">Xem chi
                                            tiết</a></button>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="wrap-temp d-flex">
                                                ...
                                                <div class="content_p ml-4">
                                                    <h4><a href="#" class="why-title a-text">Đảm bảo quyền lợi khách hàng</a></h4>
                                                    <p>
                                                    <p class="why-desc">Thực hiện các chương trình chăm sóc và gia tăng lợi ích cho khách hàng.</p>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="wrap-temp d-flex">
                                                ...
                                                <div class="content_p ml-4">
                                                    <h4><a href="#" class="why-title a-text">Tiết kiệm thời
                                                        gian và chi
                                                        phí</a></h4>
                                                    <p class="why-desc">Cập nhật giá cả nhanh chóng và chính xác giúp bạn tiết kiệm chi phí hơn nhiều</p>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 text-center">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer">Tầng 31, Keangnam Hanoi Landmark, Phạm Hùng, Nam Từ Liêm, Hà Nội</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 text-center">
                                    <div class="icon-footer">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer"><a class="a-text" href="#">1900 1881</a></p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 text-center">
                                    <div class="icon-footer">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer"><a class="a-text" href="#">hotro@batdongsan.com.vn</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-2 px-5 text-center">
                        <div class="md-5 md-4 mt-4 pb-2">
                            ...
                            <div class="form-outline form-white mb-2">
                                ...
                                <input type="text" id="typePasswordX" name="username" class="form-control form-control-lg" />
                            </div>

                            <div class="form-outline form-white mb-2">
                                <label class="form-label" for="typeEmailX">Password</label>
                                <input type="text" name="password" id="typeEmailX" class="form-control form-control-lg" />
                            </div>

                            <div class="form-outline form-white mb-2">
                                <label class="form-label" for="typeEmailX">Repeat your password</label>
                                <input type="text" name="confirmPassword" id="typeEmailX" class="form-control form-control-lg" />
                            </div>
